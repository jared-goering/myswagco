...
// FAQ data exported for use in JSON-LD
...
export default function Home() {
  ...
  const jsonLd = {
    ...
    '@graph': [
      {
        '@type': 'Organization',
        '@id': 'https://myswagco.co/#organization',
        name: 'My Swag Co',
        url: 'https://myswagco.co',
        logo: {
          '@type': 'ImageObject',
          url: 'https://myswagco.co/logo.png',
        },
        contactPoint: {
          '@type': 'ContactPoint',
      ...
      {
        '@type': 'LocalBusiness',
        '@id': 'https://myswagco.co/#localbusiness',
        name: 'My Swag Co',
        ...
        url: 'https://myswagco.co',
        priceRange: '$$',
        image: 'https://myswagco.co/og-image.png',
        email: 'hello@myswagco.co',
        aggregateRating: {
