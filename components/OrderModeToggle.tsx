...
export default function OrderModeToggle() {
  ...
  useEffect(() => {
    ...
    if (modeParam === 'campaign' && orderMode !== 'campaign') {
      setOrderMode('campaign')
    }
  }, [searchParams, orderMode, setOrderMode])
  ...
  return (
    <div className="bg-white rounded-2xl shadow-soft border border-surface-200/50 p-6 mb-8">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        >
          {/* New badge */}
          <span className="absolute -top-2 -right-2 px-2 py-0.5 bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white text-[10px] font-black rounded-full shadow-sm">
            NEW
          </span>
      ...
      <AnimatePresence>
        {orderMode === 'campaign' && (
          ...
          >
            <div className="mt-5 p-4 bg-gradient-to-r from-violet-50 to-fuchsia-50 rounded-xl border border-violet-100">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-bold text-violet-700 mb-1">What's a Group Campaign?</h4>
